...
object MockTopNData {
  ...
  def main(args: Array[String]): Unit = {
    val n = 1000000
    val path = s"F:\\BigData\\workspace\\spark-demo\\spark-core\\src\\main\\resources\\topNData\\topn\\${n}"
    val urlPath = s"F:\\BigData\\workspace\\spark-demo\\spark-core\\src\\main\\resources\\topNData\\url\\${n}"
    // 创建一个SparkContext
